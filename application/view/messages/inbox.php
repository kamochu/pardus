...
<span class="pull-right">
	<a class="btn btn-primary" target="_blank" href="<?php echo Config::get('URL'); ?>messages/inbox_pdf/?sender_address=<?=$this->sender_address?>&dest_address=<?=$this->dest_address?>&service_id=<?=$this->service_id?>&start_date=<?=$this->start_date?>&end_date=<?=$this->end_date?>" role="button">Print PDF</a>
</span>
<h1>Query Inbound Messages (Inbox)</h1>
