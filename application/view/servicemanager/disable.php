...
<span class="pull-right">
	...
	<a class="btn btn-success" href="<?php echo Config::get('URL'); ?>service/enable/<?=$this->service_id?>" role="button">Enable Service</a> &nbsp;	
...
if ($this->result['result'] == 0) {//success
	?>
    <div class="alert alert-success alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>The service <strong><?= $this->service_id ?></strong> has been disabled successfully. </div>
    <?php
} else { //failed 
	?>
    <div class="alert alert-danger alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>The service <strong><?= $this->service_id ?></strong> failed to disable. Error: <?= $this->result['result'] ?> - <?= $this->result['resultDesc'] ?> </div>
    <?php
}
?>
