...
class DeliveryController extends Controller
{
     ...
     */
	 public function receipt()
	 {
		...
		//process the data
		$model = new DeliveryModel($this->logger);
		...
		//log the event		
		$this->logger->info(
			'{class_mame}|{method_name}|process-delivery-receipt-result|{result}|{result_desc}|{data}',
			array(
				'class_mame'=>__CLASS__,
				'method_name'=>__FUNCTION__,
		...
		if ($resultData['result'] == 0) {
        	...
        	$this->View->renderWithoutHeaderAndFooter('delivery/index',$resultData);
